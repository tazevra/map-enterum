...
const regions = [
  {
    ...
    locationColor: '#F16AFF', // Цвет для названия региона Арамидис (#F16AFF)
    desc: 'Йошихара - “Город розовых слёз”. Город торговли, фестивалей и магии.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/joshixara.124/',
    polygon: [
  ...
  /*
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?forums/rikuten.138/',
    polygon: [
  ...
  },
  {
    ...
    location: 'Арамидис', // Название региона (будет выделено цветом)
    locationColor: '#F16AFF', // Цвет для названия региона Арамидис (#F16AFF)
    desc: 'Промышленный город в гораз Фармауцнтин', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/',
    polygon: [
      [3158, 1817], [3174, 1852], [3191, 1855], [3192, 1890], [3168, 1901], [3161, 1927], [3148, 1934], [3117, 1935], [3092, 1934], 
      [3086, 1927], [3079, 1906], [3075, 1874], [3079, 1845], [3091, 1821], [3098, 1812], [3121, 1822], [3142, 1816]
    ]
  },
  */
  {
    ...
    location: 'Арамидис', // Название региона (будет выделено цветом)
    locationColor: '#F16AFF', // Цвет для названия региона Арамидис (#F16AFF)
    desc: 'Игридас — город, где живут четыре обособленных народа.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/igridas.64/',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?forums/ehlgardijskaja-respublika.35/',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?forums/kartus.60/',
    polygon: [
  ...
  },
  {
    ...
    location: 'Арамидис', // Название региона (будет выделено цветом)
    locationColor: '#F16AFF', // Цвет для названия региона Арамидис (#F16AFF)
    desc: 'Джию-Мура — поселение беженцев из Аргадара на берегу Волчьей Реки.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?threads/dzhiju-mura.1108/post-40691',
    polygon: [
  ...
  },
  {
    ...
    location: 'Арамидис', // Название региона (будет выделено цветом)
    locationColor: '#F16AFF', // Цвет для названия региона Арамидис (#F16AFF)
    desc: 'Город на берегу моря, который славится своими обширными туристическими возможностями.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?threads/dzhiju-mura.1108/post-40691',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/derevnja-linvar.1782/',
    polygon: [
  ...
  // ЮНИОН
  {
    ...
    desc: 'Столица Юниона.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/gorod-ido.51/',
    polygon: [
  ...
  },
  {
    ...
    location: 'Юнион', // Название региона (будет выделено цветом)
    locationColor: '#73C2FF', // Цвет для названия региона Юнион (#73C2FF)
    desc: 'Туристическая мекка Юниона.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/dzhevel-siti.50/',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?forums/vinas.126/',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?forums/iii-siti.45/',
    polygon: [
  ...
  /*
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/karer.277/',
    polygon: [
  ...
  */
  {
    ...
    location: 'Юнион', // Название региона (будет выделено цветом)
    locationColor: '#73C2FF', // Цвет для названия региона Юнион (#73C2FF)
    desc: 'Небольшое сельское поселение. Высоко развито технологически, специализируется на производстве продуктов для близлежащих городов.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/derevnja-ehnikeevka.61/',
    polygon: [
    ...
    locationColor: '#73C2FF', // Цвет для названия региона Юнион (#73C2FF)
    desc: 'Небольшое сельское поселение. Высоко развито технологически, специализируется на производстве продуктов для близлежащих городов.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/selo-servopadovo.62/',
    polygon: [
  ...
  // КОРЗУС
  {
    ...
    desc: 'Крепость на руинах одного из уцелевших после аномалии городов.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/krepost-na-ruinax.37/',
    polygon: [
  ...
  },
  {
    ...
    location: 'Корзус', // Название региона (будет выделено цветом)
    locationColor: '#FFBA40', // Цвет для названия региона Корзус (#FFBA40)
    desc: 'Территории, закрытые туманами. До Магнетизма здесь располагался институту Морзена.', // Описание (любой текст)
    forum: 'https://enterumfrpg.ru/index.php?forums/dolina-nezhiti.39/',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?forums/bunker.42/',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/gorod-rejs-territorija-lisa.1043/post-33530',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?forums/jadovitye-dzhungli.78/',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/gnezdo.1067/post-36448',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/lager-mutantov-ashara.397/post-2879',
    polygon: [
  ...
  /*
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/ozero-gidry-vysokaja-slozhnost.1292/post-64275',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/zeljonye-topi.793/',
    polygon: [
  ...
  //НЕИЗВЕДАННЫЕ ЗЕМЛИ
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/kpp-korzus-junion.1092/post-39905',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/kpp-junion-aramidis.1175/post-46521',
    polygon: [
  ...
  },
  {
    ...
    forum: 'https://enterumfrpg.ru/index.php?threads/kpp-aramidis-korzus-vroklaj-siti.1002/post-29365',
    polygon: [
...
regions.forEach(region => {
  const shape = L.polygon(region.polygon, {
    color: 'transparent',
    weight: 2,
  ...
  shape.on('mouseover', function(e) {
    ...
    const tooltipHtml = `
      <div style="padding:10px 14px; background:#222222; border-radius:5px; box-shadow:0 2px 12px #0002; min-width:200px; border:2px solid #00A6FF;">
    ...
    `;
    this.setStyle({ color: '#FFFFFF', weight: 4, fillColor: region.locationColor || '#3388ff', fillOpacity: 0.4 });
  ...
  shape.on('mouseout', function(e) {
    this.setStyle({ color: 'transparent', weight: 2, fillColor: 'transparent', fillOpacity: 0 });
    this.closeTooltip();
  });
